...
class Test_sign_in():
        # 签到
        def test_signin(self,headers,member,vipcard_response_data):
                data={}
                try:
                        data['CpnID'] = member['CpnID']
                        data['SubID'] = member['SubID']
                        ...
                        data['Brf'] = "apitest"
                        print(data)
                        response=requests.post(url=member['url'] % '/SignIn/SignIn',data=data,headers=headers)
                        response_json = comm_way.response_dispose(response.json())
                        print(response_json)
                        assert response.status_code == 200
                        assert response_json['Success'] == True
                        ...
                        raise
        # 获取签到记录
        def test_signin_record(self,headers,member,vipcard_response_data,now_time):
                data={}
                try:
                        data['CpnID'] = member['CpnID']
                        data['SubID'] = member['SubID']
                        ...
                        response=requests.post(url=member['url'] % '/SignIn/GetSign',data=data,headers=headers)
                        response_json = comm_way.response_dispose(response.json())
                        assert response.status_code == 200
                        assert response_json['Success'] == True
...
#获取wifi密码
def test_get_wifi_password(headers,member):
        data={}
        try:
                data['CpnID'] = member['CpnID']
                data['SubID'] = member['SubID']
                response=requests.post(url=member['url'] % '/Guest/GetWiFi',data=data,headers=headers)
...
class Test_upload_receipt():
        ...
        def test_upload_receipt_s3(self,headers,member,get_s3_ticket):   
                ...
                try:
                        data['CpnID'] = member['CpnID']
                        response=requests.post(url=member['url'] % '/Guest/UnloadPic',files=get_s3_ticket['ticket'],data=data,headers=headers)
                        response_json = comm_way.response_dispose(response.json())
                        print(response_json['Message'])
                        assert response.status_code == 200
                        assert response_json['Success'] == True
...
class Test_car():
        # 添加会员车辆信息
        def test_add_car_data(self,headers,member,vipcard_response_data,car_data_random):
                data={}
                try:
                        data['CpnID'] = member['CpnID']
                        data['SubID'] = member['SubID']
                        ...
                        data['Brf'] = 'apitest'
                        data['OldCarID']=''
                        response=requests.post(url=member['url'] % '/GstCar/AddGstCar',data=data,headers=headers)
                        response_json = comm_way.response_dispose(response.json())
                        print(response_json['Message'])
                        assert response.status_code == 200
                        assert response_json['Success'] == True
                        ...
                        raise
        # 修改用户车辆信息
        def test_update_car_data(self,headers,member,car_data_response_data,car_data_random,now_time):
                data={}
                try:
                        data['CpnID'] = member['CpnID']
                        data['SubID'] = member['SubID']
                        ...
                        data['Parm'] = 'Brf'         #修改字段
                        response=requests.post(url=member['url'] % '/GstCar/UpGstCar',data=data,headers=headers)
                        response_json = comm_way.response_dispose(response.json())
                        print(response_json['Message'])
                        assert response.status_code == 200
                        assert response_json['Success'] == True
        ...
        # 获取当前用户车牌号
        def test_get_user_car_data(self,headers,member,vipcard_response_data):
                data={}
                try:
                        data['CpnID'] = '0001'
                        data['GstID'] = vipcard_response_data['gstID']
                        response=requests.post(url=member['url'] % '/GstCar/GetGstCar',data=data,headers=headers)
                        response_json = comm_way.response_dispose(response.json())
                        print(response_json['Message'])
                        assert response.status_code == 200
                        assert response_json['Success'] == True
...
# 券账户
class Test_member_ticket_account():
        # 发送优惠券
        def test_send_ticket(self,headers,member,vipcard_response_data,ticket_seed_page_response_data):
                data={}
                try:
                        data['CpnID'] = member['CpnID']
                        ...
                        print(data)
                        response=requests.post(url=member['url'] % '/Dtkt/SendTknAcc',data=data,headers=headers)
                        response_json = comm_way.response_dispose(response.json())
                        print(response_json)
                        print(response_json['Message'])
                        assert response.status_code == 200
                        ...
                        raise
        # 获取用户各个券类型下的优惠券数量
        def test_get_user_ticket_seed_number(self,headers,member,vipcard_response_data):
                data={}
                try:
                        data['CpnID'] = member['CpnID']
                        data['SubID'] = member['SubID']     
                        data['VipID'] = vipcard_response_data['vipID']         
                        data['CrdID'] = vipcard_response_data['crdID']  
                        response=requests.post(url=member['url'] % '/Dtkt/GetDtktTypeCount',data=data,headers=headers)
                        response_json = comm_way.response_dispose(response.json())
                        print(response_json['Message'])
                        assert response.status_code == 200
                        assert response_json['Success'] == True
                        ...
                        raise
        # 分页获取当前用户的优惠券
        def test_get_user_ticket_page(self,headers,member,vipcard_response_data):
                data={}
                try:
                        data['CpnID'] = member['CpnID']
                        data['VipID'] = vipcard_response_data['vipID']        
                        ...
                        data['PgIndex'] = 1       
                        data['PgSize'] = 10     
                        response=requests.post(url=member['url'] % '/Dtkt/GetDtkt',data=data,headers=headers)
                        response_json = comm_way.response_dispose(response.json())
                        print(response_json['Message'])
                        assert response.status_code == 200
                        assert response_json['Success'] == True
                        ...
                        raise
        # 查询用户已使用或已过期的优惠券
        def test_get_user_past_ticket(self,headers,member,vipcard_response_data):
                data={}
                try:
                        data['CpnID'] = member['CpnID']
                        data['VipID'] = vipcard_response_data['vipID']        
                        ...
                        response=requests.post(url=member['url'] % '/Dtkt/GetUsedDtkt',data=data,headers=headers)
                        response_json = comm_way.response_dispose(response.json())
                        print(response_json['Message'])
                        assert response.status_code == 200
                        assert response_json['Success'] == True
...
# 获取首页广告位 
def test_get_index_advert_position(headers,member):
        data={}
        try:
                data['CpnID'] = member['CpnID']
                data['SubID'] = member['SubID']
                data['ShwPosi'] = '1'
                response=requests.post(url=member['url'] % '/AdPosi/GetAdPosiByMobileet',data=data,headers=headers)
                response_json = comm_way.response_dispose(response.json())
                print(response_json['Message'])
                assert response.status_code == 200
                assert response_json['Success'] == True
        ...
        def test_get_park_order_page(self,manage,headers):
                ...
                try:    
                        ...
                        if response_json['Data']['PageDataList']:
                                ...
                                comm_way.sql_insert('park_order_page_response_data',response_json['Data']['PageDataList'][0])
                        ...
                        raise
        # 停车缴费
        def test_park_pay(self,headers,manage,member,register_response_data,park_order_page_response_data):
                data={}
                try:    
                        data['CpnID'] = manage['CpnID']
                        data['SubID'] = manage['SubID']
...
class Test_integral_shop_commodity():
        # 获取积分商城上架列表
        def test_get_shop_commodity_list(self,headers,member):
                data={}
                try:
                        data['CpnID'] = member['CpnID']
                        data['SubID'] = member['SubID']
                        ...
                        if response_json['Data']['GdsList']:
                                x=(random.randint(0,len(response_json['Data']['GdsList'])))
                                if x==len(response_json['Data']['GdsList']):
                                        x=x-1
                                # mysql insert get shop commodity_list response data
                                comm_way.sql_insert('shop_commodity_page_response_data',response_json['Data']['GdsList'][x])
                        ...
                        raise
        # 获取单个商品上架信息
        def test_commodity_putaway_data(self,headers,member,shop_commodity_page_response_data):
                print(shop_commodity_page_response_data)
                data={}
                try:
                        data['CpnID'] = member['CpnID']
                        data['SubID'] = member['SubID']
                        data['GdsCnvrtID'] = shop_commodity_page_response_data['gdsCnvrtID']    # 商品上架ID
                        response=requests.post(url=member['url'] % '/IntgShop/QueryGdsCnvrt',data=data,headers=headers)
                        response_json = comm_way.response_dispose(response.json())
                        print(response_json['Message'])
                        assert response.status_code == 200
                        assert response_json['Success'] == True
                        # mysql insert get shop commodity_putaway_data response data
                        comm_way.sql_insert('shop_commodity_response_data',response_json['Data']['GdsCnvrtInfo'])
                        print(response_json['Data']['GdsCnvrtInfo'])
                        
                except:
                        raise
        # 添加/删除用户收藏/感兴趣
        def test_add_user_collect(self,headers,member,vipcard_response_data,shop_commodity_response_data):
                data={}
                try:
                        data['CpnID'] = member['CpnID']
                        data['SubID'] = member['SubID']
                        data['GstID'] = vipcard_response_data['gstID']  
                        data['GdsCnvrtID'] = shop_commodity_response_data['id']    # 商品上架ID
                        data['FavType'] = '0'       # 收藏类型[0：收藏，1：感兴趣]
                        data['IsAdd'] = 'true'     # 是否添加[true：添加，false：删除收藏数据]
                        response=requests.post(url=member['url'] % '/IntgShop/AddGstFav',data=data,headers=headers)
                        response_json = comm_way.response_dispose(response.json())
                        print(response_json['Message'])
                        assert response.status_code == 200
                        assert response_json['Success'] == True
        ...
        # 获取用户收藏感兴趣
        def test_get_user_collect(self,headers,member,vipcard_response_data,shop_commodity_response_data):
                data={}
                try:
                        data['CpnID'] = member['CpnID']
                        data['SubID'] = member['SubID']
                        data['GstID'] = vipcard_response_data['gstID']  
                        data['GdsCnvrtID'] = shop_commodity_response_data['id']   #商品上架ID[可为空，不为空则查询该上架商品的收藏信息]
                        data['GdsID'] = shop_commodity_response_data['gdsID']        # 商品编码ID
                        data['FavType'] = '0'     # 收藏类型[0：收藏，1：感兴趣]
                        response=requests.post(url=member['url'] % '/IntgShop/QueryGstFav',data=data,headers=headers)
                        response_json = comm_way.response_dispose(response.json())
                        print(response_json['Message'])
                        assert response.status_code == 200
                        assert response_json['Success'] == True
...
class Test_integral_shop_order():
        # 积分商城添加订单
        def test_add_shop_order(self,member,headers,vipcard_response_data,shop_commodity_response_data):
                data={}
                try:
                        data['CpnID'] = member['CpnID']
                        data['SubID'] = member['SubID']
                        ...
                        data['FcttsIntg'] = float(shop_commodity_response_data['fcttsIntg'])*2    #应付积分
                        data['PaidIntg'] = float(shop_commodity_response_data['fcttsIntg'])*2     #实付积分
                        data['Prc'] = '0'          #应付金额
                        data['PaidPrc'] = '0'      #实付金额
                        # data['Frei'] = '0'         #运费
                        ...
                        data['CnvrtIDs'] = shop_commodity_response_data['id']     #上架ID 
                        data['GdsCodes'] = shop_commodity_response_data['gdsID']     #商品条码
                        data['SubCodes'] = ''     #商品子码
                        data['Typs'] = shop_commodity_response_data['typ']         #商品类型
                        data['Names'] = shop_commodity_response_data['gdsName']        #商品名称
                        data['SubNames'] = ''     #子码描述
                        data['ImgUrlss'] = shop_commodity_response_data['imgUrls']      #商品主图
                        ...
                        data['TknAccID'] = ''     #优惠券账号
                        data['Brf'] = 'apitest'
                        response=requests.post(url=member['url'] % '/IntgShop/AddCnvrtOrder',data=data,headers=headers)
                        response_json = comm_way.response_dispose(response.json())                                
                        print(response_json['Message'])
                        assert response.status_code == 200
                        assert response_json['Success'] == True
        ...
        # 积分商城查询订单分页
        def test_get_shop_order_page(self,member,headers,vipcard_response_data):
                data={}
                try:
                        data['CpnID'] = member['CpnID']
                        data['SubID'] = member['SubID']
                        ...
                        data['PageSize'] = '10'      
                        data['Stt'] = '0'     
                        response=requests.post(url=member['url'] % '/IntgShop/QueryCnvrtOrderList',data=data,headers=headers)
                        response_json = comm_way.response_dispose(response.json())
                        print(response_json['Message'])
                        assert response.status_code == 200
                        assert response_json['Success'] == True
                        if response_json['Data']['Data']:
                                ...
                                comm_way.sql_insert('shop_order_page_response_data',response_json['Data']['Data'][0])
                                for i in response_json['Data']['Data']:
                                        print(i)
                        else:
                                print('没有订单')
                        ...
                        raise
        # 积分商城支付
        def test_shop_order_pay(self,headers,member,shop_order_page_response_data,vipcard_response_data):
                data={}
                try:
                        data['CpnID'] = member['CpnID']
                        data['SubID'] = member['SubID']
                        ...
                        data['PayType'] = '3'   
                        data['IntgAmt'] =int(float(shop_order_page_response_data['paidIntg']))     #支付积分  
                        data['Money'] = int(float(shop_order_page_response_data['paidPrc']))       #支付金额
                        data['OrgID'] = '0000'     
                        data['VipID'] = vipcard_response_data['vipID']    
